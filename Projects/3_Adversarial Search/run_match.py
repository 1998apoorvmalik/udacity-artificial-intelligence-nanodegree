...
from isolation import Agent, Isolation, play
...
def main(args):
    ...
    logger.info("Your agent won {:.1f}% of matches against {}".format(100.0 * wins / num_games, test_agent.name))
    print("Your agent won {:.1f}% of matches against {}".format(100.0 * wins / num_games, test_agent.name))
    print()
